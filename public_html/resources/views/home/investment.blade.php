...
<article class="main-layout__content">
            ...
            <section class="page-intro page-intro-investments">
              <div class="container container-large"> 
                <h1 class="page-intro__title">RELIABLE TRADING WITH {{$settings->site_name}}<br></h1><br><br>
                <h1 class="page-intro__title"style="color: #69e2b0;">Trades</h1>
                <div class="page-intro__description"> 
                  <p><span class="color-primary">GET LIFE-TIME PROFITS</span></p>
                </div>		
				<style>
			#class {
    max-width: 100%;
...
<p>{{$settings->site_name}} CFO has developed a unique marketing plan for the platform to function fully. The Traders of our company have an excellent opportunity to receive financial benefits on stable terms. You can also use the profitability calculator. It will calculate the exact profit on your trades.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="deposits">
              <div class="container container-large">
                <div class="section-intro"> 
                  <h3 class="title">Trade Proposals                  </h3>
                  <div class="section-intro__description"> 
                    <p style="margin-top: -20px;">{{$settings->site_name}} employees ensure that every trader in our company can earn money</p>
                  </div>
                </div>
                    ...
                    <div class="deposits__col-sidebar"> 
                      <div class="limits-warning"> 
                        ...
                        <div class="limits-warning__content">
                          <p>These commissions are charged by {{$settings->site_name}} for the platform to work. They are not related to the profit received by our traders</p>
                        </div>
                      </div>
                    </div>
              ...
              <div class="payments-and-footer-wrapper__inner"style="padding-top: 70px;">
                  ...
                  <div class="container">
                    <div class="payments__row"> 
					  ...
					  <a class="btn btn--line-primary" href="login"><span>TRADE</span></a>
				                             </div>
                        </div>
                      </div>
                    </div>
